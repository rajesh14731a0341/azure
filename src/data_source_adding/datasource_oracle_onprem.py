...
# ===============================
# ON-PREM ORACLE CONFIG
# ===============================
DS_NAME = "finastra-onprem-oracle"
ORACLE_HOST = "20.51.200.183"
ORACLE_PORT = 1521
ORACLE_SERVICE_NAME = "FINASTRA_PDB"
...
# ===============================
# HELPERS (SAFE HIERARCHY RESOLUTION)
# ===============================
def normalize(x):
...
def run_registration():
    try:
        ...
        # --------------------------------------------------
        # STEP 2: Define Oracle Data Source
        # --------------------------------------------------
        body_input = {
            "kind": "Oracle",
            "properties": {
        ...
        # --------------------------------------------------
        print(f"Registering Oracle data source: {DS_NAME}")
